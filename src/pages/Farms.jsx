    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl p-6">
        ...
        <p className="text-xs text-red-500 mb-5">
          This will fail if the farm has existing batches.
        </p>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-gray-400">
            ...
            <p className="text-sm font-medium">No farms yet</p>
            <p className="text-xs mt-1">Click "New Farm" to add your first one</p>
          </div>
        ) : (
            ...
            <tbody className="divide-y divide-gray-50">
              {farms.map(farm => (
                <tr key={farm.id} className="hover:bg-amber-50/40 transition">
                  <td className="px-5 py-4 font-medium text-gray-800">{farm.name}</td>
